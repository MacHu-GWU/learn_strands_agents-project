---
description: Add comprehensive unit tests for the specified Python source code file. Example: `/add-test-for-module /path/to/learn_strands_agents/math_ops.py comprehensive "optional additional requirements"`
allowed-tools: Write(learn_strands_agents/**/*.py), Write(tests/**/*.py), Bash(.venv/bin/python tests/**/*.py)
---
