# -*- coding: utf-8 -*-
#
# learn_strands_agents documentation build configuration file, created by
...
import learn_strands_agents as package
...
# Add data for Jinja2
try:
    from learn_strands_agents.docs import doc_data
except:
    doc_data = dict()
